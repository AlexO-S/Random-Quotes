// inspirational quote stored as multiple strings within an array

var quotes = [
    {
        quote: "Do what you love and love what you do.",
        source: "Alex O. Salami"
    },
    ...
    {
        quote: "Great hope make great men.",
        source: "Alex O. Salami"
    }
];
...
function printQuote () {
    ...
    var quoteString = '<p class="quote">' +quotes[selectQuote].quote +'</p><p class="source">' + quotes[selectQuote].source;
        ...
        if (quotes[selectQuote].citation) 
        {quoteString += '<span class="citation">' + quotes[selectQuote].citation + '</span>';
        }
